  ...
  fr: {
    translation: {
      ...
      recharge: {
        ...
        selectCardCount: "Nombre de cartes",
        cardCountHint: "Combien de cartes voulez-vous scanner ?",
        cardXofY: "Carte {{step}}/{{total}}",
        cardScanned: "Carte {{step}} ✓",
        nextCard: "Carte suivante",
        finishScan: "Terminer",
        scanSummary: "Récapitulatif",
        launchAll: "Tout recharger ({{count}})",
        launchingXofY: "Recharge {{step}}/{{total}}...",
        allLaunched: "Toutes les recharges ont été envoyées !",
        selectScannedCode: "Plusieurs codes détectés",
      },
      withdrawal: {
        ...
        scan: "Scanner",
        scanLabel: "SCAN CASHPOINT",
        placeCard: "Placez le numéro dans le cadre",
        stepLoading: "Chargement de l'image...",
        stepAnalyzing: "Analyse en cours...",
        stepExtracting: "Extraction du numéro...",
        stepFinalizing: "Finalisation...",
        textNotDetectedTitle: "Texte non détecté",
        textNotDetectedMsg: "Aucun texte n'a été trouvé. Veuillez réessayer.",
        numberNotDetectedTitle: "Numéro non détecté",
        numberNotDetectedMsg: "Aucun numéro commençant par 03 et comportant 10 chiffres trouvé. Veuillez centrer le numéro et réessayer.",
        ocrErrorTitle: "Erreur OCR",
        galleryPermissionDeniedTitle: "Permission refusée",
        galleryPermissionDeniedMsg: "L'accès à la galerie est requis.",
        captureErrorMsg: "Impossible de capturer la photo depuis la caméra.",
      },
  ...
  en: {
    translation: {
      ...
      recharge: {
        ...
        selectCardCount: "Number of cards",
        cardCountHint: "How many cards do you want to scan?",
        cardXofY: "Card {{step}}/{{total}}",
        cardScanned: "Card {{step}} ✓",
        nextCard: "Next card",
        finishScan: "Finish",
        scanSummary: "Summary",
        launchAll: "Recharge all ({{count}})",
        launchingXofY: "Recharging {{step}}/{{total}}...",
        allLaunched: "All recharges have been sent!",
        selectScannedCode: "Multiple codes detected",
      },
      withdrawal: {
        ...
        scan: "Scan",
        scanLabel: "SCAN CASHPOINT",
        placeCard: "Place the number inside the frame",
        stepLoading: "Loading image...",
        stepAnalyzing: "Analyzing...",
        stepExtracting: "Extracting number...",
        stepFinalizing: "Finalizing...",
        textNotDetectedTitle: "Text not detected",
        textNotDetectedMsg: "No text found. Please try again.",
        numberNotDetectedTitle: "Number not detected",
        numberNotDetectedMsg: "No 10-digit number starting with 03 found. Please center the number and try again.",
  ...
  mg: {
    translation: {
      ...
      recharge: {
        ...
        selectCardCount: "Isan'ny karatra",
        cardCountHint: "Firy ny karatra tianao hoscannerina?",
        cardXofY: "Karatra {{step}}/{{total}}",
        cardScanned: "Karatra {{step}} ✓",
        nextCard: "Karatra manaraka",
        finishScan: "Vita",
        scanSummary: "Famintinana",
        launchAll: "Recharger daholo ({{count}})",
        launchingXofY: "Manome hery {{step}}/{{total}}...",
        allLaunched: "Vita daholo ny recharge!",
        selectScannedCode: "Kaody maromaro hita",
      },
      withdrawal: {
        ...
        scan: "Skanera",
        scanLabel: "SKANERA TOERANA FISINTONANA",
        placeCard: "Apetraho eo amin'ny cadre ny laharana",
        stepLoading: "Mampiditra sary...",
        stepAnalyzing: "Mandinika...",
        stepExtracting: "Mamoaka laharana...",
        stepFinalizing: "Famaranana...",
        textNotDetectedTitle: "Tsy hita ny soratra",
        textNotDetectedMsg: "Tsy nahitana soratra. Andramo indray.",
        numberNotDetectedTitle: "Tsy hita ny laharana",
        numberNotDetectedMsg: "Tsy nahitana laharana manomboka amin'ny 03 misy tarehimarika 10. Ampifanitsio tsara ny laharana dia andramo indray.",
        ocrErrorTitle: "Hadisoana OCR",
        galleryPermissionDeniedTitle: "Tsy nahazo alalana",
        galleryPermissionDeniedMsg: "Mila alalana hidirana amin'ny sary.",
        captureErrorMsg: "Tsy afaka naka sary tamin'ny camera.",
      },
