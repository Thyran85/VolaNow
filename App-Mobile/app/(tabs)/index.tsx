      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            <View style={styles.iconBox}><Ionicons name="wallet-outline" size={22} color="#CCFF00" /></View>
          ...
          <TouchableOpacity style={styles.actionButton} onPress={() => router.push('/(withdrawal)/withdrawal')}>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            <View style={styles.iconBox}><Ionicons name="swap-horizontal" size={22} color="#CCFF00" /></View>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            <View style={styles.iconBox}><Ionicons name="flash-outline" size={22} color="#CCFF00" /></View>
